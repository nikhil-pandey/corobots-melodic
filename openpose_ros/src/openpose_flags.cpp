...
// OpenPose
DEFINE_string(model_folder,             "/home/np7803/openpose/models",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
DEFINE_int32(display,                   2,             "Display mode: -1 for automatic selection; 0 for no display (useful if there is no X server"
